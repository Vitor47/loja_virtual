...
urlpatterns = [
    ...
    path(
        "create_grupo_acesso/",
        views.create_grupo_acesso,
        name="create_grupo_acesso",
    ),
    path(
        "edit_grupo_acesso/<int:id>",
        views.edit_grupo_acesso,
        name="edit_grupo_acesso",
    ),
    path(
    ...
    path(
        "add_users_group/<int:id_group>",
        views.add_users_group,
