...
from ..forms.create_conta import CreateUserForm, CreateClienteForm, CreateClienteEnderecoForm
...
def login(request):
    ...
    if request.method == "GET":
        ...
        try:
            ...
            messages.error(request, "Aconteceu algum erro insesperado favor tentar novamente!")
            return render(request, "conta/login.html", context=context)
...
def create_count(request):
    ...
    if request.method == "GET":
        ...
        if create_form_user.is_valid() and create_form_cliente.is_valid() and create_form_cliente_endereco.is_valid():
            ...
            messages.error(request, "Algum campo obrigatorio não preenchido, favor tentar novamente!")
            return redirect('/criar-conta/')
