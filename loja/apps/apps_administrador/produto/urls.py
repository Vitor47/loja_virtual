...
urlpatterns = [
    ...
    path('create_categoria_produto/', views.create_categoria_produto, name='create_categoria_produto'),
    path('edit_categoria_produto/<int:id>', views.edit_categoria_produto, name='edit_categoria_produto'),
    path('delete_categoria_produto/<int:id>', views.delete_categoria_produto, name='delete_categoria_produto'),
    path('atributo_produto/', views.atributo_produto, name='atributo_produto'),
    path('create_atributo_produto/', views.create_atributo_produto, name='create_atributo_produto'),
